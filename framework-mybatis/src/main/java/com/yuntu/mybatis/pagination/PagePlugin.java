package com.yuntu.mybatis.pagination;


import com.yuntu.common.utils.ReflectUtils;
import com.yuntu.mybatis.dialect.Dialect;
import com.yuntu.mybatis.dialect.MysqlDialect;
...
public class PagePlugin  implements Interceptor {
    ...
    //数据方言类
    private String dialectClass=com.yuntu.mybatis.dialect.MysqlDialect.class.getName();
    //默认数据方言
	...
	public Object intercept(Invocation invocation) throws Throwable {
        ...
        if( target instanceof  RoutingStatementHandler){ //设置分页属性,更改查询结果为分页结果
            ...
            for(Object object :  invocation.getArgs() ){
                ...
                Page<Object> page = ReflectUtils.findMemberByType(object, Page.class);
                if( null != page ){
                    page.setData((java.util.List<Object>) result);
                    return result;
                }
            }
        }
